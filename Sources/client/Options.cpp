...
OptionString skinModel("skinModel", "steve");
OptionString panoramaPath("panoramaPath", "title/bg/panorama");
...
OptionBool waterShader("waterShader", true);
...
OptionInt language("language", 0, 0, 10);
...
void Options::initTable() {
	...
	m_options[OPTIONS_WATER_SHADER] = &waterShader;
