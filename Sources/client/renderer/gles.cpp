...
#if 1
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, vertexSize, (GLvoid*)(3 * 4));
...
void drawArrayVTC(int bufferId, int vertices, int vertexSize /* = 36 */) {
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, vertexSize, 0);
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, vertexSize, (GLvoid*) (3 * 4));
	glVertexAttribPointer(2, 4, GL_UNSIGNED_BYTE, GL_TRUE, vertexSize, (GLvoid*) (5*4));
...
void drawArrayVTN(int bufferId, int vertices, int vertexSize /* = 36 */) {
 ...
 glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, vertexSize, 0);
 glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, vertexSize, (GLvoid*) (3 * 4));
 glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, vertexSize, (GLvoid*) (6 * 4));
 ...
 glVertexPointer2(  3, GL_FLOAT, vertexSize, 0);
 glTexCoordPointer2(2, GL_FLOAT, vertexSize, (GLvoid*) (3 * 4));
 glNormalPointer(GL_FLOAT, vertexSize, (GLvoid*) (6 * 4));   // offset del normal
...
void drawArrayVTN_NoState(int bufferId, int vertices, int vertexSize /* = 36 */) {
 glBindBuffer2(GL_ARRAY_BUFFER, bufferId);
