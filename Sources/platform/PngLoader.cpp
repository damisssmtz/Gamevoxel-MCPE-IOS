...
// PngLoader is not used on iOS (iOS uses UIImage / CGImage in AppPlatform_iOS.mm)
// libpng (png.h) is not included in standard iOS SDK.

#if defined(HTTPCLIENT_USE_OPENSSL) || defined(USE_LIBPNG)
